---
name: team-project-workflow
description: 团队本地 monorepo 多项目任务编排技能，使用真实 develop 分支作为集成基线。仅在用户明确要求使用 team-project-workflow 时使用。
---
...
- main agent：拆分任务、维护根记录、准备 worktree、分批分派 subagent、merge 项目分支到 `<task-id>`、最终验收并将任务分支 merge 回真实 `develop`。
