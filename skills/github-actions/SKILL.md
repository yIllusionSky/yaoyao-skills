---
name: github-actions
description: 创建或维护 Rust 项目的 GitHub Actions CI、app、Tauri 2 和 Docker tag release workflow；Docker assets 适用于独立 server crate，可选叠加 SvelteKit adapter-node client。用于 `.github/workflows/*.yml`、release assets、Dockerfile、compose 和复制脚本。
---
