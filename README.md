...
- `github-actions`: 规范 GitHub Actions CI、app、Tauri 2 和 Docker tag release，并为独立 Rust 项目及 TypeScript + Rust monorepo 提供隔离的 CI、Docker release、Compose 和 Pingap assets。
