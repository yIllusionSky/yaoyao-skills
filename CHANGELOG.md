...
- 添加 `project-workflow` 技能，串联项目初始化、大功能 issue/PR、crate 级 subagent 实现、独立 review、issue 验收核对和返工闭环，并明确依赖技能发现、首个有效 commit 后创建 PR、子项目 crate 修改顺序、crate 级格式化与测试范围、主集成层独立 review。
