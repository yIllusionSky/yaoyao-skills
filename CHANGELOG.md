...
- 添加 `project-workflow` 技能，编排 `.workflow/<task-id>/` 本地任务记录、`develop` 基线 detached worktree、subagent 实现、review、主集成和总体验收闭环，并通过 references 定义任务格式、主 agent 流程、subagent 流程和 worktree 规则。
